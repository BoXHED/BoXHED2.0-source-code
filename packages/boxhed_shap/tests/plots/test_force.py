...
def test_random_force_plot_mpl_with_data():
    ...
    boxhed_shap.force_plot(explainer.expected_value, shap_values[0, :], X.iloc[0, :], matplotlib=True, show=False)
...
def test_random_force_plot_mpl_text_rotation_with_data():
    ...
    # visualize the first prediction's explaination
    boxhed_shap.force_plot(explainer.expected_value, shap_values[0, :], X.iloc[0, :], matplotlib=True, text_rotation=30, show=False)
