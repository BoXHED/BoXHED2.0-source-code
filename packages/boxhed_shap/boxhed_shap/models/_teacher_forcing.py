...
class TeacherForcing(Model):
    ...
    def save(self, out_file):
        ...
        with Serializer(out_file, "boxhed_shap.models.TeacherForcing", version=0) as s:
    ...
    def load(cls, in_file, instantiate=True):
        ...
        with Deserializer(in_file, "boxhed_shap.models.TeacherForcing", min_version=0, max_version=0) as s:
