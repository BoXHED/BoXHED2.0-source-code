...
class TransformersPipeline(Model):
    ...
    tensors as expected by boxhed_shap. This class wraps pipelines to make them output nice
    tensor formats.
    """
    ...
    def __call__(self, strings):
        assert not isinstance(strings, str), "boxhed_shap.models.TransformersPipeline expects a list of strings not a single string!"
