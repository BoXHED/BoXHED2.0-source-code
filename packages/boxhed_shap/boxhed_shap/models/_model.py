...
class Model(Serializable):
    ...
    def __init__(self, model=None):
        """ Wrap a callable model as a boxhed_shap Model object.
        """
    ...
    def save(self, out_file):
        ...
        """
        super().save(out_file)
        with Serializer(out_file, "boxhed_shap.Model", version=0) as s:
    ...
    def load(cls, in_file, instantiate=True):
        ...
        with Deserializer(in_file, "boxhed_shap.Model", min_version=0, max_version=0) as s:
