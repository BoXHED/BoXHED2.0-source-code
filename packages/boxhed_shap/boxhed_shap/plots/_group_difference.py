...
def group_difference(shap_values, group_mask, feature_names=None, xlabel=None, xmin=None, xmax=None, 
    ...
    """ This plots the difference in mean boxhed_shap values between two groups.
    ...
    shap_values : numpy.array
        Matrix of boxhed_shap values (# samples x # features) or a vector of model outputs (# samples).
    ...
    # See if we were passed a single model output vector and not a matrix of boxhed_shap values
    ...
    if xlabel is None:
        xlabel = "Group boxhed_shap value difference"
