...
def heatmap(shap_values, instance_order=Explanation.hclust(), feature_values=Explanation.abs.mean(0), 
            ...
            plot_width=8):
    """ Create a heatmap plot of a set of boxhed_shap values.
    ...
    feature values but by their explanations. By default we cluster using boxhed_shap.utils.hclust_ordering
    ...
    instance_order : OpChain or numpy.ndarray
        A function that returns a sort ordering given a matrix of boxhed_shap values and an axis, or
    ...
    # sort the boxhed_shap values matrix by rows and columns
    ...
    #     #xlabel += " " + instance_order.summary_string("boxhed_shap values")
    ...
    # plot the matrix of boxhed_shap values as a heat map
    ...
    if True:
        ...
        cb.set_label("boxhed_shap value", size=12, labelpad=-10)
