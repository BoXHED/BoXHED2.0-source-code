...
github_data_url = "https://github.com/slundberg/boxhed_shap/raw/master/data/"
...
def california(display=False, n_points=None): # pylint: disable=unused-argument
    ...
    if n_points is not None:
        df = boxhed_shap.utils.sample(df, n_points)
        target = boxhed_shap.utils.sample(target, n_points)
