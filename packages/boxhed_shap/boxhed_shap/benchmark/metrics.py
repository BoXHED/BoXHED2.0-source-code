...
def consistency_guarantees(X, y, model_generator, method_name):
    ...
    # 0.0 - no garuntees
    guarantees = {
        "linear_boxhed_shap_corr": 1.0,
        "linear_boxhed_shap_ind": 1.0,
        "coef": 0.0,
        "kernel_boxhed_shap_1000_meanref": 0.8,
        "sampling_boxhed_shap_1000": 0.8,
        "random": 0.0,
        "saabas": 0.0,
        "tree_gain": 0.0,
        "tree_boxhed_shap_tree_path_dependent": 1.0,
        "tree_boxhed_shap_independent_200": 1.0,
        "mean_abs_tree_boxhed_shap": 1.0,
        "lime_tabular_regression_1000": 0.8,
        "lime_tabular_classification_1000": 0.8,
        "maple": 0.8,
        "tree_maple": 0.8,
        "deep_boxhed_shap": 0.6,
