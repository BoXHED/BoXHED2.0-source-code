...
metadata = {
    ...
    # "linear_boxhed_shap_corr": {
    #     "title": "Linear boxhed_shap (corr)"
    # },
    # "linear_boxhed_shap_ind": {
    #     "title": "Linear boxhed_shap (ind)"
    # },
    # "coef": {
    #     "title": "Coefficents"
    # },
    ...
    #     "title": "Random"
    # },
    # "kernel_boxhed_shap_1000_meanref": {
    #     "title": "Kernel boxhed_shap 1000 mean ref."
    # },
    # "sampling_boxhed_shap_1000": {
    #     "title": "Sampling boxhed_shap 1000"
    # },
    # "tree_boxhed_shap_tree_path_dependent": {
    #     "title": "Tree boxhed_shap"
    # },
    # "saabas": {
    #     "title": "Saabas"
    # },
    ...
    # },
    # "mean_abs_tree_boxhed_shap": {
    #     "title": "mean(|Tree boxhed_shap|)"
    # },
    # "lasso_regression": {
...
benchmark_color_map = {
    "tree_boxhed_shap": "#1E88E5",
    "deep_boxhed_shap": "#1E88E5",
    "linear_boxhed_shap_corr": "#1E88E5",
    "linear_boxhed_shap_ind": "#ff0d57",
    "coef": "#13B755",
    "random": "#999999",
    "const_random": "#666666",
    "kernel_boxhed_shap_1000_meanref": "#7C52FF"
}
...
def plot_grids(dataset, model_names, out_dir=None):
    ...
    prefix = "<style type='text/css'> .boxhed_shap_benchmark__select:focus { outline-width: 0 }</style>"
    out = "" # background: rgb(30, 136, 229)
    
    # out += "<div style='font-weight: regular; font-size: 24px; text-align: center; background: #f8f8f8; color: #000; padding: 20px;'>boxhed_shap Benchmark</div>\n"
...
#                 out += "<td rowspan='%d' style='background: #fff; text-align: center; white-space: nowrap; vertical-align: middle; '><div style='font-weight: bold; transform: rotate(-90deg); transform-origin: left top 0; width: 1.5em; margin-top: 8em'>%s</div></td>" % (data.shape[0], model_name)
            ...
            out += "<td style='background: #ffffff; text-align: right; width: 250px' title='boxhed_shap.LinearExplainer(model)'>" + method_title + "</td>\n"
            for j in range(data.shape[1]):
    ...
    out += "<div style='float: left; font-weight: regular; font-size: 24px; color: #000;'>boxhed_shap Benchmark <span style='font-size: 14px; color: #777777;'>v"+__version__+"</span></div>\n"
# select {
#   margin: 50px;
#   width: 150px;
...
# }
    ...
    out += "<select id='boxhed_shap_benchmark__select' onchange=\"document.location = '../' + this.value + '/index.html'\"dir='rtl' class='boxhed_shap_benchmark__select' style='font-weight: normal; font-size: 20px; color: #000; padding: 10px; background: #fff; border: 1px solid #fff; -webkit-appearance: none; appearance: none;'>\n"
    ...
    out += "</select>\n"
    #out += "<script> document.onload = function() { document.getElementById('boxhed_shap_benchmark__select').value = '"+dataset+"'; }</script>"
