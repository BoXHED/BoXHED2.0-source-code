...
def add_sample_images(path):
    """
    Function to add sample images from imagenet50 boxhed_shap data in the given folder.
    """
    X, _ = boxhed_shap.datasets.imagenet50()
    counter = 1
...
def resize_image(path_to_image, reshaped_dir):
    ...
    Hence, large image files are being reshaped in code below to increase speed of boxhed_shap explanations and run Azure COGS for image captions. 
