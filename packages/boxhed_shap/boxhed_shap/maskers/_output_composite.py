...
class OutputComposite(Masker):
    ...
    def __init__(self, masker, model):
        ...
        ----------
        masker: object
            An object of the boxhed_shap.maskers.Masker base class (eg. Text/Image masker).

        model: object
            An object boxhed_shap.models.Model base class used to generate output.
    ...
    def save(self, out_file):
        ...
        with Serializer(out_file, "boxhed_shap.maskers.OutputComposite", version=0) as s:
    ...
    def load(cls, in_file, instantiate=True):
        ...
        with Deserializer(in_file, "boxhed_shap.maskers.OutputComposite", min_version=0, max_version=0) as s:
