...
class FixedComposite(Masker):
    ...
    def save(self, out_file):
        ...
        with Serializer(out_file, "boxhed_shap.maskers.FixedComposite", version=0) as s:
    ...
    def load(cls, in_file, instantiate=True):
        ...
        with Deserializer(in_file, "boxhed_shap.maskers.FixedComposite", min_version=0, max_version=0) as s:
