...
class Tabular(Masker):
    ...
    def __init__(self, data, max_samples=100, clustering=None):
        ...
        max_samples : int
            ...
            than max_samples then boxhed_shap.utils.sample is used to subsample the dataset. The number of
        ...
        #                 "run times. Consider boxhed_shap.utils.sample(data, K) to summarize the background using only K samples.")
    ...
    def save(self, out_file):
        ...
        with Serializer(out_file, "boxhed_shap.maskers.Tabular", version=0) as s:
    ...
    def load(cls, in_file, instantiate=True):
        ...
        with Deserializer(in_file, "boxhed_shap.maskers.Tabular", min_version=0, max_version=0) as s:
