...
class Additive(Explainer):
    """ Computes boxhed_shap values for generalized additive models.
    ...
    def __init__(self, model, masker, link=None, feature_names=None, linearize_link=True):
        ...
        masker : function or numpy.array or pandas.DataFrame
            ...
            game structure you can pass a boxhed_shap.maskers.Tabular(data, hclustering=\"correlation\") object, but
        ...
        assert safe_isinstance(self.masker, "boxhed_shap.maskers.Independent"), "The Additive explainer only supports the Tabular masker at the moment!"
...
#         Only the standard interventional boxhed_shap values are supported by AdditiveExplainer right now.
#     """
