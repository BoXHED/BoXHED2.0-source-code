...
class Partition(Explainer):
    ...
    def __init__(self, model, masker, *, output_names=None, link=links.identity, linearize_link=True,
        ...
        """ Uses the Partition boxhed_shap method to explain the output of any function.

        Partition boxhed_shap computes boxhed_shapley values recursively through a hierarchy of features, this
        ...
        masker : function or numpy.array or pandas.DataFrame or tokenizer
            ...
            functions are available in boxhed_shap such as boxhed_shap.maksers.Image for images and boxhed_shap.maskers.Text
            for text.
        ...
        partition_tree : None or function or numpy.array
            ...
            example. If you are using a standard boxhed_shap masker object then you can pass masker.clustering
        ...
        Examples
        --------
        See `Partition explainer examples <https://boxhed_shap.readthedocs.io/en/latest/api_examples/explainers/Partition.html>`_
        """
        ...
        if not safe_isinstance(self.model, "boxhed_shap.models.Model"):
        ...
        if getattr(self.masker, "clustering", None) is None:
            raise ValueError("The passed masker must have a .clustering attribute defined! Try boxhed_shap.maskers.Partition(data) for example.")
    ...
    def __str__(self):
        return "boxhed_shap.explainers.Partition()"
