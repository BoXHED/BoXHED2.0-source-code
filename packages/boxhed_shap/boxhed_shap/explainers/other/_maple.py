...
class Maple(Explainer):
    """ Simply wraps MAPLE into the common boxhed_shap interface.
    ...
    def attributions(self, X, multiply_by_input=False):
        ...
        multiply_by_input : bool
            ...
            values roughly comparable to boxhed_shap values.
        """
...
class TreeMaple(Explainer):
    """ Simply tree MAPLE into the common boxhed_shap interface.
