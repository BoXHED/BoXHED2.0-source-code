...
static PyObject *_cext_dense_tree_boxhed_shap(PyObject *self, PyObject *args);
...
static PyMethodDef module_methods[] = {
    {"dense_tree_boxhed_shap", _cext_dense_tree_boxhed_shap, METH_VARARGS, "C implementation of Tree boxhed_shap for dense."},
    ...
    {"dense_tree_saabas", _cext_dense_tree_saabas, METH_VARARGS, "C implementation of Saabas (rough fast approximation to Tree boxhed_shap)."},
...
static struct PyModuleDef moduledef = {
    ...
    "_cext",
    "This module provides an interface for a fast Tree boxhed_shap implementation.",
    -1,
    module_methods,
    NULL,
    NULL,
...
static PyObject *_cext_dense_tree_boxhed_shap(PyObject *self, PyObject *args)
{
    ...
    dense_tree_boxhed_shap(trees, data, out_contribs, feature_dependence, model_output, interactions);
