...
void dense_tree_boxhed_shap_gpu(const TreeEnsemble& trees, const ExplanationDataset &data, tfloat *out_contribs,
...
static PyObject *_cext_dense_tree_boxhed_shap(PyObject *self, PyObject *args)
{
    ...
    dense_tree_boxhed_shap_gpu(trees, data, out_contribs, feature_dependence, model_output, interactions);
